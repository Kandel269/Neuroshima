...
urlpatterns = [
    ...
    path('usuń-wiadomość/<str:pk>/', login_required(MessagesDeleteView.as_view()), name='delete_message'),
    path('edytuj-wiadomość/<str:pk>/', login_required(MessagesUpdateView.as_view()), name='update_message'),
